...
from bioCRNpyler_files.propensities import *
...
class BacterialTranscription(Mechanism):
    ...
    def update_reactions(self, dna, component, part_id = None, complex = None, transcript = None, protein = None,
        ...
        rnap_sigma_binding_propensity = ResourceAllocationPropensity(k_f = k_tx_1b, k_r = k_tx_1u, reactant = self.sigma, 
        ...
        propensity_open_complex = DeltaWithBasal(k = k_tx_2u, c = self.cell_count, c_max = c_max, x = open_complex, 
...
class BacterialDegradation_mRNA(GlobalMechanism, MichaelisMenten):
    ...
    def update_reactions(self, s, mixture):
        ...
        if s.material_type == "rna":
            ...
            propensity_complex = DeltaWithBasal(k = k_tx_4u, c = self.cell_count, c_max = c_max, x = complex_deg, 
            b = b_tx_4u, positive = True, n = n_delta)
...
class BacterialTranslation(Mechanism):
    ...
    def update_reactions(self, transcript, protein, component, part_id = None, complex=None, **keywords):
        ...
        aa_Et_binding_propensity = ResourceAllocationPropensity(k_f = k_tl_1b, k_r = k_tl_1u, reactant = self.aminoacid, 
        ...
        tRNA_Ct_binding_propensity = ResourceAllocationPropensity(k_f = k_tl_2b, k_r = k_tl_2u, reactant = self.Ct, 
        ...
        mRNA_Ribosome_binding_propensity = ResourceAllocationPropensity(k_f = k_tl_3b, k_r = k_tl_3u, reactant = transcript, 
        ...
        folding_propensity = ApplyGammaPropensity(k = k_tl_5, x = self.unfolded_protein, b = b_tl_5, c = self.cell_count,
        ...
        if self.degtag: 
            ...
            unfolded_P_protease_binding_propensity = ResourceAllocationPropensity2Products(k_f = k_tl_9b_P, k_r = k_tl_9u, reactant = self.unfolded_protein, 
            ...
            folded_P_protease_binding_propensity = ResourceAllocationPropensity2Products(k_f = k_tl_9b_Pm, k_r = k_tl_9u, reactant = protein, 
                                                                                  R_max = Protease_max, n = n_gamma_Protease,
                                                                                  c = self.cell_count, c_max = c_max,
                                                                                  product_1 = self.C_deg_unfolded, product_2 = self.C_deg_folded, 
...
class BacterialDegradation_active(GlobalMechanism):
    ...
    def update_reactions(self, s, mixture):
        if s.material_type == "protein": 
            ...
            propensity_dp = DeltaPropensity(k = k_tl_7, c = self.cell_count, c_max = c_max, x = s, 
...
class DilutionLogGrowth(GlobalMechanism):
    ...
    def update_reactions(self, s: Species, mixture):
        ...
        if isinstance(s, ComplexSpecies):
            dilution_propensity = AlphaPropensity(k = k_gr, c = self.cell_count, c_max = c_max, x = s)
