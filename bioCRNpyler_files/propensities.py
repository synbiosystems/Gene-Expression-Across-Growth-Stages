...
class AlphaPropensity(Propensity):
    def __init__(self, k: float, c: Species, c_max: float, x : Species):
        """AlphaPropensity is a propensity with the following formula.
...
class DeltaPropensity(Propensity):
    def __init__(self, k: float, c: Species, c_max: float, x : Species, n : float, positive = True):
        """Delta is a propensity with the following formula.
...
class DeltaWithBasal(Propensity):
    def __init__(self, k: float, c: Species, c_max: float, x : Species, b : float, n : float, positive = True):
        """delta_with_basal is a propensity with the following formula.
...
class ApplyGammaPropensity(Propensity):
...
class ResourceAllocationPropensity(Propensity):
...
class ResourceAllocationPropensity2Products(Propensity):
    def __init__(self, k_f : float, k_r : float, reactant : Species, R_max : float, n : float, 
