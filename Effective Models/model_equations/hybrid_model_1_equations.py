...
def run_model(param, degtag, tspan):
    ...
    def model_odes(x, t, param, degtag = 1):
        """
        Function to define the ODEs for the hybrid model - 1"""
        p = param.valuesdict()
        ...
        n = 5.5 # Hill coefficient for the delta, fixed parameter
        ...
        dAdt = k_lag * Pc + k_syn - r_aa_charging - d_dil * A
        dCdt = k_gr * C * (1 - f)
